[library](../../index.md) / [net.gahfy.livebinders.extension](../index.md) / [android.widget.TextView](index.md) / [addLiveAutoSizeTextTypeWithDefaults](./add-live-auto-size-text-type-with-defaults.md)
