[library](../../index.md) / [net.gahfy.livebinders.extension](../index.md) / [android.widget.TextView](index.md) / [setMutableAutoSizeTextTypeWithDefaults](./set-mutable-auto-size-text-type-with-defaults.md)
